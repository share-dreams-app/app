# Prompt - Início da Fase 3

Copie e cole o texto abaixo em um novo chat:

```text
Execute a Fase 3 do projeto Share Dreams usando o plano em /home/leandro-baires/projects/share_dreams/docs/superpowers/plans/2026-04-15-shared-dreams-mvp-implementation.md e o framework em /home/leandro-baires/projects/share_dreams/AGENTS.md.
...
5. Mantenha escopo estrito da Fase 3 (Tasks 8, 9).
6. Não implemente itens fora de escopo; registre follow-ups no handoff.

Branch da fase:
- Use exatamente: phase/3-personalization-rewards
...
1. npm run test -- tests/api/suggestions-hybrid.test.ts tests/api/rewards-tiered.test.ts
2. Cobertura global >= 90% (statements, branches, functions, lines).

Entregáveis obrigatórios:
1. Commits na branch da fase.
2. Handoff em /home/leandro-baires/projects/share_dreams/docs/superpowers/handoffs/2026-04-15-phase-3-handoff.md
3. Push da branch.
